<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><i class="fas fa-sign-out-alt"></i> Egresos Simples</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active">Gestión Financiera</li>
                    <li class="breadcrumb-item active">Egresos</li>
                    <li class="breadcrumb-item active">Egresos Simples</li>
                </ol>
            </div>
        </div>
    </div>
		                	...
		                	<form id="form_egresos" name="form_egreso" encType="multipart/form-data">
		                		...
		                		<div class="card">
						            <div class="card-body bg-light">
						                <div class="container-fluid">
						                	<div class="row">
						                		<h5 class="card-title"><i class="fas fa-search"></i> Buscar</h5> 
						                	</div>
						                	<br>
					                		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
						                		<div class="card">
