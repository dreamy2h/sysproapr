<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><i class="fas fa-dollar-sign"></i> Costo por Metros</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active">Configuración</li>
                    <li class="breadcrumb-item active">Costo por Metros</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
            ...
            <div class="col-xl-42 col-4g-12 col-md-12 col-sm-12">
            	<div class="card">
                	<div class="card-header">
                		<i class="fas fa-dollar-sign mr-1"></i> Datos de Costo
                	</div>
		            <div class="card-body">
		            	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            	<div class="card">
                	<div class="card-header">
                		<i class="fas fa-dollar-sign mr-1"></i> Listado de Costos por APR
                	</div>
		            <div class="card-body">
		            	<div class="container-fluid">
