<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><i class="fas fa-hand-holding-usd"></i> Subsidios</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            	<div class="card">
                	<div class="card-header" data-toggle="collapse" data-target="#datosSubsidio" aria-expanded="false" aria-controls="datosSubsidio">
                		<i class="fas fa-hand-holding-usd"></i> Datos del Subsidio
                	</div>
		            <div class="card-body collapse" id="datosSubsidio">
		            	<div class="container-fluid">
			...
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            	<div class="card">
                	<div class="card-header">
                		<i class="fas fa-hand-holding-usd"></i> Listado de Subsidios
                	</div>
		            <div class="card-body">
		            	<div class="container-fluid">
