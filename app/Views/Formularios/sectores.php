<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><i class="fas fa-location-arrow"></i> Sectores</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            	<div class="card">
                	<div class="card-header" data-toggle="collapse" data-target="#datosSector" aria-expanded="false" aria-controls="datosSector">
                		<i class="fas fa-location-arrow"></i> Datos Sector
                	</div>
		            <div class="card-body collapse" id="datosSector">
		            	<div class="container-fluid">
			...
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            	<div class="card mb-4">
                	<div class="card-header">
                		<i class="fas fa-location-arrow"></i> Listado de Sectores
                	</div>
		            <div class="card-body">
		            	<div class="container-fluid">
