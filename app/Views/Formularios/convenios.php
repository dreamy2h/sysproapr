<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><i class="fas fa-handshake"></i> Convenios</h1>
            </div>
            <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            	<div class="card">
		            ...
		            <div class="card-body collapse" id="datosConvenio">
		            	<div class="container-fluid">
			...
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            	<div class="card">
                	<div class="card-header">
                		<i class="fas fa-handshake"></i> Listado de Convenios (Doble click, para ver el detalle)
                	</div>
		            <div class="card-body">
		            	<div class="container-fluid">
