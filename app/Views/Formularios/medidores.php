<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><i class="fas fa-faucet mr-1"></i> Medidores</h1>
            </div>
            <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            	<div class="card">
		            ...
		            <div class="card-body collapse" id="datosMedidor">
		            	<div class="container-fluid">
		                	<form id="form_medidor" name="form_medidor" encType="multipart/form-data">
		                		<div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label class="small mb-1" for="txt_consumo">Consumo m<sup>3</sup></label>
                                            <input type='text' class="form-control" id='txt_consumo' name="txt_consumo" />
                                        </div>
                                    </div>
		                		</div>
		                	</form>
			...
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            	<div class="card">
                	<div class="card-header">
                		<i class="fas fa-faucet mr-1"></i> Listado de Medidores
                	</div>
		            <div class="card-body">
		            	<div class="container-fluid">
