<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><i class="fas fa-exchange-alt"></i> Cambios de Medidor</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active">Formularios</li>
                    <li class="breadcrumb-item active">Cambio de Medidor</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            	<div class="card">
		            ...
		            <div class="card-body collapse" id="datosCambioMedidor">
		            	<div class="container-fluid">
		                	<form id="form_cambio_medidor" name="form_cambio_medidor" encType="multipart/form-data">
			                    ...
			                    <div class="card shadow mb-12">
						            <div class="card-body bg-light">
						                <div class="container-fluid">
						                	<div class="row">
						                		<h5 class="card-title"><i class="fas fa-search"></i> Buscar Socio</h5> 
						                	</div>
					                		<div class="row">
			                    ...
			                    <div class="card shadow mb-12">
						            <div class="card-body bg-light">
						                <div class="container-fluid">
						                	<div class="row">
						                		<h5 class="card-title"><i class="fas fa-search"></i> Buscar Funcionario</h5> 
						                	</div>
					                		<div class="row">
					                			<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
						                			<div class="form-group">
			...
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            	<div class="card">
                	<div class="card-header">
                		<i class="fas fa-exchange-alt"></i> Listado de Cambios de Medidor
                	</div>
		            <div class="card-body">
		            	<div class="container-fluid">
