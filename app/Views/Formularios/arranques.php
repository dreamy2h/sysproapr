<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><i class="fas fa-swimming-pool"></i> Arranques</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active">Formularios</li>
                    <li class="breadcrumb-item active">Arranques</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            	<div class="card">
                	<div class="card-header" data-toggle="collapse" data-target="#datosArranque" aria-expanded="false" aria-controls="datosArranque">
                		<i class="fas fa-swimming-pool"></i> Datos del Arranque
                	</div>
		            <div class="card-body collapse" id="datosArranque">
		            	<div class="container-fluid">
			...
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            	<div class="card">
                	<div class="card-header">
                		<i class="fas fa-swimming-pool"></i> Listado de Arranques
                	</div>
		            <div class="card-body">
		            	<div class="container-fluid">
