<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><i class="fas fa-tint"></i> Informe de Consumo del Agua</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active">Informes</li>
                    <li class="breadcrumb-item active">Control del Agua</li>
                    <li class="breadcrumb-item active">Informe de Consumo del Agua</li>
                </ol>
            </div>
        </div>
    </div>
    	...
    	<div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            	<div class="card">
		            ...
		            <div class="card-body collapse" id="informeConsumoAgua">
		            	<div class="container-fluid">
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
		                	<div class="card">
			                	<div class="card-header">
			                		<i class="fas fa-tint"></i> Resultados de Búsqueda
			                	</div>
					            <div class="card-body">
					            	<div class="container-fluid">
