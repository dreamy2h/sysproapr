<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><i class="fas fa-file-invoice"></i> Informe de Arqueo</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active">Informes</li>
                    <li class="breadcrumb-item active">Informe de Arqueo</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            	<div class="card">
                	<div class="card-header" data-toggle="collapse" data-target="#informeArqueo" aria-expanded="false" aria-controls="informeArqueo">
                		<i class="fas fa-file-invoice"></i> Buscar
                	</div>
		            <div class="card-body collapse" id="informeArqueo">
		            	<div class="container-fluid">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            	<div class="card">
                	<div class="card-header">
                		<i class="fas fa-file-invoice"></i> Historial de Pagos (Doble click, Ver Detalle)
                	</div>
		            <div class="card-body">
		            	<div class="container-fluid">
