...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><i class="fas fa-tint"></i> Consumo de agua en m<sup>3</sup></h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active">Consumo</li>
                    <li class="breadcrumb-item active">Metros</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            	<div class="card">
                	<div class="card-header" data-toggle="collapse" data-target="#datosMetros" aria-expanded="false" aria-controls="datosMetros">
                		<i class="fas fa-tint"></i> Ingreso de Metros
                	</div>
		            <div class="card-body collapse" id="datosMetros">
		            	<div class="container-fluid">
			...
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            	<div class="card">
                	<div class="card-header">
                		<i class="fas fa-tint"></i> Historial Metros (Muestra los últimos 10.000 registros)
                	</div>
		            <div class="card-body">
		            	<div class="container-fluid">
		            		<div class="table-responsive">
