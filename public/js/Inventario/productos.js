    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                ...
                Toast.create("Éxito", "Productos guardados con éxito", TOAST_STATUS.SUCCESS, 5000);
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                if (opcion == "desactivar") {
                    Toast.create("Éxito", "Producto desactivado con éxito", TOAST_STATUS.SUCCESS, 5000);
                } else {
                    Toast.create("Éxito", "Producto activado con éxito", TOAST_STATUS.SUCCESS, 5000);
                }
...
function agregar_cantidad() {
    ...
    if ($("#txt_id_producto").val() != "") {
        ...
        if (numero < numero_datatable) {
            Toast.create("Advertencia", "Para eliminar productos, debe darlos de baja", TOAST_STATUS.WARNING, 5000);
        } else {
        ...
        if (numero > 0) {
            ...
            Toast.create("Advertencia", "Ingrese un número válido", TOAST_STATUS.WARNING, 5000);
        }
    }
}
...
function modificar_detalle() {
    ...
    if (filas > 0) {
        ...
        Toast.create("Advertencia", "Debe seleccionar la fila que desea actualizar", TOAST_STATUS.WARNING, 5000);
    }
}
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                ...
                Toast.create("Éxito", "Unidad dada de baja, de manera exitosa", TOAST_STATUS.SUCCESS, 5000);
            } else {
                Toast.create("Error", respuesta, TOAST_STATUS.DANGER, 5000);
            }
        },
...
$(document).ready(function() {
    ...
    $("#btn_desactivar").on("click", function() {
        ...
        if (cantidad == 0) {
            ...
            Toast.create("Advertencia", "No puede desactivar un producto que tiene unidades activas", TOAST_STATUS.WARNING, 5000);
        }
    });
