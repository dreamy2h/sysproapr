    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                ...
                Toast.create("Éxito", "Ubicación guardada con éxito", TOAST_STATUS.SUCCESS, 5000);
...
function cambiar_estado_ubicacion(opcion, observacion, id_ubicacion) {
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                if (opcion == "eliminar") {
                    Toast.create("Éxito", "Ubicación eliminada con éxito", TOAST_STATUS.SUCCESS, 5000);
                } else {
                    $('#dlg_reciclar_ubicacion').modal('hide');
                    Toast.create("Éxito", "Ubicación recuperada con éxito", TOAST_STATUS.SUCCESS, 5000);
                }
