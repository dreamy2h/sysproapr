    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                ...
                Toast.create("Éxito", "Estado guardado con éxito", TOAST_STATUS.SUCCESS, 5000);
...
function cambiar_estado(opcion, observacion, id_estado) {
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                if (opcion == "eliminar") {
                    Toast.create("Éxito", "Estado eliminado con éxito", TOAST_STATUS.SUCCESS, 5000);
                } else {
                    $('#dlg_reciclar_estado').modal('hide');
                    Toast.create("Éxito", "Estado reciclado con éxito", TOAST_STATUS.SUCCESS, 5000);
                }
