    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                ...
                Toast.create("Éxito", "Motivo guardado con éxito", TOAST_STATUS.SUCCESS, 5000);
...
function eliminar_motivo(opcion, observacion, id_motivo) {
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                if (opcion == "eliminar") {
                    Toast.create("Éxito", "Motivo eliminado con éxito", TOAST_STATUS.SUCCESS, 5000);
                } else {
                    $('#dlg_reciclar_motivo').modal('hide');
                    Toast.create("Éxito", "Motivo reciclado con éxito", TOAST_STATUS.SUCCESS, 5000);
                }
