    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                ...
                Toast.create("Éxito", "Funcionario guardado con éxito", TOAST_STATUS.SUCCESS, 5000);
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                ...
                des_habilitar(true, false);
                if (estado == "eliminar") {
                    Toast.create("Éxito", "Funcionario eliminado con éxito", TOAST_STATUS.SUCCESS, 5000);
                } else {
                    $('#dlg_reciclar_funcionario').modal('hide');
                    Toast.create("Éxito", "Funcionario recuperado con éxito", TOAST_STATUS.SUCCESS, 5000);
                }
            } else {
                Toast.create("Error", respuesta, TOAST_STATUS.DANGER, 5000);
            }
    ...
    $("#txt_rut").on("blur", function() {
        if (this.value != "") {
            if (Fn.validaRut(Fn.formatear(this.value))) {
                ...
                Toast.create("Error", "RUT incorrecto", TOAST_STATUS.DANGER, 5000);
                this.value = "";
