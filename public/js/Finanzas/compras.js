    ...
    $.ajax({
        ...
        success: function(respuesta) {
            if (respuesta > 0) {
                ...
                Toast.create("Éxito", "Producto agregado de manera exitosa", TOAST_STATUS.SUCCESS, 5000);
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            if (respuesta > 0) {
                ...
                Toast.create("Éxito", "Compra guardada de manera exitosa", TOAST_STATUS.SUCCESS, 5000);
            } else {
                Toast.create("Error", respuesta, TOAST_STATUS.DANGER, 5000);
            }
        },
