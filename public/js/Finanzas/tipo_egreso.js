    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                ...
                Toast.create("Éxito", "Tipo de egreso guardado con éxito", TOAST_STATUS.SUCCESS, 5000);
...
function cambiar_estado_tipo_egreso(opcion, observacion, id_tipo_egreso) {
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                if (opcion == "eliminar") {
                    Toast.create("Éxito", "Tipo de egreso eliminado con éxito", TOAST_STATUS.SUCCESS, 5000);
                } else {
                    $('#dlg_reciclar_tipo_egreso').modal('hide');
                    Toast.create("Éxito", "Tipo de egreso reciclado con éxito", TOAST_STATUS.SUCCESS, 5000);
                }
