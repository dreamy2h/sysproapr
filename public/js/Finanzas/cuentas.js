    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                ...
                Toast.create("Éxito", "Cuenta guardada con éxito", TOAST_STATUS.SUCCESS, 5000);
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                ...
                des_habilitar(true, false);
                if (estado == "eliminar") {
                    Toast.create("Éxito", "Cuenta eliminada con éxito", TOAST_STATUS.SUCCESS, 5000);
                } else {
                    $('#dlg_reciclar_cuenta').modal('hide');
                    Toast.create("Éxito", "Cuenta recuperada con éxito", TOAST_STATUS.SUCCESS, 5000);
                }
            } else {
               Toast.create("Error", respuesta, TOAST_STATUS.DANGER, 5000);
            }
