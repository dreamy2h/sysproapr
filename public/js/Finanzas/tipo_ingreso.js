    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                ...
                Toast.create("Éxito", "Tipo de ingreso guardado con éxito", TOAST_STATUS.SUCCESS, 5000);
...
function cambiar_estado_tipo_ingreso(opcion, observacion, id_tipo_ingreso) {
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                if (opcion == "eliminar") {
                    Toast.create("Éxito", "Tipo de ingreso eliminado con éxito", TOAST_STATUS.SUCCESS, 5000);
                } else {
                    $('#dlg_reciclar_tipo_ingreso').modal('hide');
                    Toast.create("Éxito", "Tipo de ingreso reciclado con éxito", TOAST_STATUS.SUCCESS, 5000);
                }
