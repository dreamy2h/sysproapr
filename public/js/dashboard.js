...
function grafico_socios() {
    $.ajax({
        type: "GET",
        dataType: "json",
        url: base_url + "/index.php/Ctrl_dashboard/llenar_grafico_socios",
    }).done( function(data) {
        var sexo = [];
        var cantidad = [];
...
function grafico_mensualidad() {
    $.ajax({
        type: "GET",
        dataType: "json",
        url: base_url + "/index.php/Informes/Ctrl_informe_mensual/datatable_informe_mensual/0",
    }).done( function(data) {
        var labels = [];
        var subtotal = [];
        var subsidios = [];
...
$(document).ready(function() {
    ...
    $("#card_socios").on("click", function(){
        $("#contenido").load(base_url + "/index.php/ctrl_menu/socios");
    });

    $("#card_informe_mensual").on("click", function(){
        $("#contenido").load(base_url + "/index.php/ctrl_menu/informe_mensualidad");
    });

    $("#card_afecto_corte").on("click", function(){
        $("#contenido").load(base_url + "/index.php/ctrl_menu/informe_afecto_corte");
    });
    
    $("#card_informe_municipal").on("click", function(){
        $("#contenido").load(base_url + "/index.php/ctrl_menu/informe_municipalidad_subsidios");
    });
