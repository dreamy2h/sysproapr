    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                ...
                Toast.create("Éxito", "Servicio guardado con éxito", TOAST_STATUS.SUCCESS, 5000);
...
function eliminar_servicio(opcion, observacion, id_servicio) {
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                if (opcion == "eliminar") {
                    Toast.create("Éxito", "Servicio eliminado con éxito", TOAST_STATUS.SUCCESS, 5000);
                } else {
                    $('#dlg_reciclar_servicios').modal('hide');
                    Toast.create("Éxito", "Servicio reciclado con éxito", TOAST_STATUS.SUCCESS, 5000);
                }
