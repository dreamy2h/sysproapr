    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                ...
                Toast.create("Éxito", "Medidor guardado con éxito", TOAST_STATUS.SUCCESS, 5000);
...
function eliminar_medidor(opcion, observacion, id_medidor) {
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                if (opcion == "eliminar") {
                    Toast.create("Éxito", "Medidor eliminado con éxito", TOAST_STATUS.SUCCESS, 5000);
                } else {
                    $('#dlg_reciclar').modal('hide');
                    Toast.create("Éxito", "Medidor reciclado con éxito", TOAST_STATUS.SUCCESS, 5000);
                }
...
$(document).ready(function() {
    ...
    $("#txt_consumo").prop("disabled", true);
    des_habilitar(true, false);
    llenar_cmb_diametro();
    ...
    $("#btn_nuevo").on("click", function() {
        ...
        $("#txt_consumo").prop("disabled", false);
