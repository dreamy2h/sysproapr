    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                ...
                Toast.create("Éxito", "Socio guardado con éxito", TOAST_STATUS.SUCCESS, 5000);
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                ...
                des_habilitar(true, false);
                if (estado == "eliminar") {
                    Toast.create("Éxito", "Socio eliminado con éxito", TOAST_STATUS.SUCCESS, 5000);
                } else {
                    $('#dlg_reciclar_socio').modal('hide');
                    Toast.create("Éxito", "Socio recuperado con éxito", TOAST_STATUS.SUCCESS, 5000);
                }
            } else {
                Toast.create("Error", respuesta, TOAST_STATUS.DANGER, 5000);
            }
