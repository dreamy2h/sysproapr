    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                ...
                Toast.create("Éxito", "Subsidio guardado con éxito", TOAST_STATUS.SUCCESS, 5000);
...
function eliminar_subsidio(opcion, observacion, id_subsidio) {
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                if (opcion == "eliminar") {
                    Toast.create("Éxito", "Subsidio eliminado con éxito", TOAST_STATUS.SUCCESS, 5000);
                } else {
                    $('#dlg_reciclar_subsidio').modal('hide');
                    Toast.create("Éxito", "Subsidio reciclado con éxito", TOAST_STATUS.SUCCESS, 5000);
                }
