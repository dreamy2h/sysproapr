    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                ...
                Toast.create("Éxito", "Sector guardado con éxito", TOAST_STATUS.SUCCESS, 5000);
...
function eliminar_sector(opcion, observacion, id_sector) {
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                if (opcion == "eliminar") {
                    Toast.create("Éxito", "Sector eliminado con éxito", TOAST_STATUS.SUCCESS, 5000);
                } else {
                    $('#dlg_reciclar').modal('hide');
                    Toast.create("Éxito", "Sector reciclado con éxito", TOAST_STATUS.SUCCESS, 5000);
                }
