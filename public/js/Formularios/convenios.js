    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                ...
                Toast.create("Éxito", "Convenio guardado con éxito", TOAST_STATUS.SUCCESS, 5000);
...
function eliminar_convenio(opcion, observacion, id_convenio) {
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                if (opcion == "eliminar") {
                    Toast.create("Éxito", "Convenio eliminado con éxito", TOAST_STATUS.SUCCESS, 5000);
                } else {
                    $('#dlg_reciclar_convenios').modal('hide');
                    Toast.create("Éxito", "Convenio reciclado con éxito", TOAST_STATUS.SUCCESS, 5000);
                }
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                ...
                Toast.create("Éxito", "Repactación éxitosa", TOAST_STATUS.SUCCESS, 5000);
            } else {
                Toast.create("Error", respuesta, TOAST_STATUS.DANGER, 5000);
            }
        },
