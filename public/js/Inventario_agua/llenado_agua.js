    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                ...
                Toast.create("Éxito", "Llenado de agua guardado con éxito", TOAST_STATUS.SUCCESS, 5000);
...
function eliminar_llenado(observacion, id_llenado) {
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                Toast.create("Éxito", "Llenado de agua eliminado con éxito", TOAST_STATUS.SUCCESS, 5000);
                $("#grid_llenado").dataTable().fnReloadAjax(base_url + "/Inventario_agua/Ctrl_llenado/datatable_llenado");
            } else {
                Toast.create("Error", respuesta, TOAST_STATUS.DANGER, 5000);
            }
