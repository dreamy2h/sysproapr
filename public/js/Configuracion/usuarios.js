    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta.substring(0, 1) == OK) {
                ...
                Toast.create("Éxito", "Usuario guardado con éxito", TOAST_STATUS.SUCCESS, 5000);
...
function bloquear_usuario(opcion, observacion) {
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                if (opcion == "bloquear") {
                    Toast.create("Éxito", "Usuario bloqueado con éxito", TOAST_STATUS.SUCCESS, 5000);
                } else {
                    Toast.create("Éxito", "Usuario desbloqueado con éxito", TOAST_STATUS.SUCCESS, 5000);
                }
