    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                ...
                Toast.create("Éxito", "Consumo de metros, guardado con éxito", TOAST_STATUS.SUCCESS, 5000);
...
function eliminar_metros(observacion, id_metros) {
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta == OK) {
                Toast.create("Éxito", "Consumo de metros, eliminado con éxito", TOAST_STATUS.SUCCESS, 5000);
                $("#grid_metros").dataTable().fnReloadAjax(base_url + "/Consumo/Ctrl_metros/datatable_metros");
            } else {
                Toast.create("Error", respuesta, TOAST_STATUS.DANGER, 5000);
            }
...
function calcular_montos() {
    ...
    if (parseInt(consumo_actual) >= parseInt(consumo_anterior)) {
        ...
        $("#txt_c_actual").val("");
        Toast.create("Éxito", "El <strong>connsumo actual</strong>, no puede ser menor al <strong>consumo anterior</strong>", TOAST_STATUS.SUCCESS, 5000);
    }
}
